...
@FacesConverter("converterFinanceiro")
public class ConverteFinanceiro implements Converter,Serializable {
...
public String getAsString(FacesContext facesContext, UIComponent uiComponent, Object value) {
    if (value instanceof Financeiro) {
        ...
        if (entity != null && entity instanceof Financeiro && entity.getId() != null) {
